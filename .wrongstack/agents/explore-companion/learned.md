...
<!-- learned-stamp: category=warning; capturedAt=2026-08-21T20:46:01.647Z; applied=4; wins=4 -->
...
<!-- learned-stamp: category=warning; capturedAt=2026-08-21T18:52:31.629Z; applied=32; wins=31 -->
...
<!-- learned-stamp: category=warning; capturedAt=2026-08-21T20:34:09.873Z; applied=17; wins=17 -->
...
<!-- learned-stamp: category=warning; capturedAt=2026-08-21T19:52:13.602Z; skill=node-modern; applied=9; wins=9 -->
...
<!-- learned-stamp: category=warning; capturedAt=2026-08-21T19:15:30.282Z; applied=7; wins=7 -->
...
<!-- learned-stamp: category=warning; capturedAt=2026-08-21T19:25:21.130Z; applied=12; wins=12 -->
...
<!-- learned-stamp: category=warning; capturedAt=2026-08-22T07:22:49.756Z; skill=typescript-strict; applied=3; wins=3 -->
...
<!-- learned-stamp: category=convention; capturedAt=2026-08-22T08:04:04.701Z; skill=node-modern; applied=4; wins=4 -->
- **Verify core storage changes with a targeted root-config run (`npx vitest run packages/core/tests/storage/<file>.test.ts` from repo root) instead of `pnpm --filter @wrongstack/core test` - the package script runs the entire `packages/core/tests` tree via `vitest run --root ../..` and wastes minutes on unrelated suites.**
  - *Why:* Established convention for this codebase — skipping it risks regressions, merge friction, or out-of-sync state with peers.
  - *How:* `npx vitest run packages/core/tests/storage/<file>.test.ts`
  - *How:* `pnpm --filter @wrongstack/core test`
  - *How:* `packages/core/tests`
  - *How:* `vitest run --root ../..`
  - *How:* `@wrongstack/core`

---
*Last capture: 2026-08-22T08:04:04.701Z · 8 entries*
