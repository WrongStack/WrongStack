...
In-tree project state: committed `.wrongstack/project.json` (stable `proj_<ULID>` shared by HQ), `.wrongstack/AGENTS.md`, `.wrongstack/skills/`, optional `.wrongstack/config.json`; everything else in `~/.wrongstack/projects/<hash>/`.
