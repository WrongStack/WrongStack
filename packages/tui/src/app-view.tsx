...
export function AppView({ host, runtime }: AppViewProps): React.ReactElement {
  ...
  // `sidebarWidth > 0` matters: an open overlay collapses the sidebar to
  // width 0 (nothing renders — see the RightSidebar gate below), and without
  // this term the data hooks kept polling the registry every 2s and the disk
  // every 10s for panels nobody could see.
                ...
                ? (() => {
                    ...
                    return (
                      <RefineCountdownPanel
                        // Fresh instance per countdown: inheriting a previous
                        // countdown's expired interval wedged the panel at "0s…".
