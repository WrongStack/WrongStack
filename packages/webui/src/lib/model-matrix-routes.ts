...
const BROWSER_AGENT_ROUTES = {
  ...
  verify: [
    ['realtime', 'Realtime'],
    ['resilience-engineer', 'Resilience Engineer'],
  ...
  review: [
    ...
    ['secure-coding-coach', 'Secure Coding Coach'],
  ...
  meta: [
    ...
    ['context', 'Context'],
    ['cost', 'Cost'],
    ['tech-stack', 'Tech Stack Validator'],
    ['plugin-author', 'Plugin Author'],
    ['tool-author', 'Tool Author'],
    ['prompt-evaluator', 'Prompt Evaluator'],
...
const MODEL_MATRIX_ROUTE_ROLES: readonly ModelMatrixRouteRole[] = MODEL_MATRIX_ROUTE_GROUPS.flatMap(
  (group) => [...group.roles],
);
