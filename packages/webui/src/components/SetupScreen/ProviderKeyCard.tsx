            ...
            <div className="mt-3 space-y-1">
              {savedProvider?.baseUrl && (
                <div className="text-[11px] text-muted-foreground/70 font-mono truncate" title={savedProvider.baseUrl}>
                  <span className="text-muted-foreground/50">{t('activity:providerKey.url')} </span>{savedProvider.baseUrl}
                </div>
              )}
              {savedProvider?.models && savedProvider.models.length > 0 && (
                <div className="text-[11px] text-muted-foreground/70">
                  <span className="text-muted-foreground/50">{t('activity:providerKey.models')} </span>
              ...
              <>
                ...
                <div className="w-full space-y-2">
                  ...
                  <div className="flex items-center justify-center gap-2">
                    ...
                    >
                      <svg role="img" aria-hidden="true" className="h-3.5 w-3.5" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    >
                      <svg role="img" aria-hidden="true" className="h-3.5 w-3.5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
