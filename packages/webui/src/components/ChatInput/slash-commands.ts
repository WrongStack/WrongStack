...
export const SLASH_COMMANDS: SlashCommandDef[] = [
  ...
  { name: '/goal', category: 'Agent', description: 'Goal: start <title> | pause | resume | stop | status' },
  { name: '/goal-state', category: 'Agent', description: 'Show the current goal state (opens the Goal State dock chip)' },
